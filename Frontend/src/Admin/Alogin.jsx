...
const Alogin = () => {
  ...
  return (
    ...
    {/* <h2 style={{ position: "relative", bottom: "300px", right: "300px", transform: "scaleX(-1.5)",}} > <Link to="/" className='text-gray-500 hover:text-gray-900'><FaSignOutAlt/></Link></h2> */}
      ...
      <div className="relative  bg-green-500 p-8 rounded-md shadow-md overflow-hidden" style={{display:"flex",height:"350px",width:"550px"}}>
      <div>
        <img src='https://www.einfochips.com/blog/wp-content/uploads/2023/06/2_Blog_Featured_Image-scaled.jpg' width='200px' style={{marginRight:"35px",height:"298px"}} />
      </div>
